...
class administrationsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.administrations.buttons.actions')
    ...
    {
        return administration::query()->with(['publicAdmin_id',])->select("administrations.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'publicAdmin_id.publicAdmin',
                 'data'=>'publicAdmin_id.publicAdmin',
                 'title'=>trans('admin.publicAdmin_id'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
