...
class attendancesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.attendances.buttons.actions')
    ...
    {
        return attendance::query()->with(['emp_id',])->select("attendances.*")  ;
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'att_days',
                 'data'=>'att_days',
                 'title'=>trans('admin.att_days'),
		    ],
				[
                 'name'=>'absent_days',
                 'data'=>'absent_days',
                 'title'=>trans('admin.absent_days'),
		    ],
				[
                 'name'=>'note',
                 'data'=>'note',
