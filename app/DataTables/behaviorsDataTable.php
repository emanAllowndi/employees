...
class behaviorsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.behaviors.buttons.actions')
    ...
    {
        return behavior::query()->with(['emp_id',])->select("behaviors.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'behavior',
                 'data'=>'behavior',
                 'title'=>trans('admin.behavior'),
		    ],
				[
                 'name'=>'bedate',
                 'data'=>'bedate',
                 'title'=>trans('admin.bedate'),
		    ],
				[
                 'name'=>'beyear',
                 'data'=>'beyear',
                 'title'=>trans('admin.beyear'),
		    ],
				[
