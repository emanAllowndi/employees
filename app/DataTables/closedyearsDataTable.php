...
class closedyearsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.closedyears.buttons.actions')
    ...
    {
        return closedyear::query()->select("closedyears.*")  ;
            ...
            ->parameters([
               'responsive'   => true,
                ...
                'buttons' => [
                  ...
                  //  ],
                [
                        'text' => '<i class="fa fa-plus"></i> '.trans('admin.addcolosed'),
