...
class coursenumsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.coursenums.buttons.actions')
    ...
    {
        return coursenum::query()->with(['emp_id',])->select("coursenums.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'coursenum',
                 'data'=>'coursenum',
                 'title'=>trans('admin.coursenum'),
		    ],
				[
                 'name'=>'numdate',
                 'data'=>'numdate',
                 'title'=>trans('admin.numdate'),
		    ],
				[
                 'name'=>'numyear',
                 'data'=>'numyear',
                 'title'=>trans('admin.numyear'),
		    ],
				[
                 'name'=>'nummonth',
                 'data'=>'nummonth',
                 'title'=>trans('admin.nummonth'),
		    ],
				[
