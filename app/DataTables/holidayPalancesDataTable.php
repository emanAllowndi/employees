...
class holidayPalancesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.holidaypalances.buttons.actions')
    ...
    {
        return holidayPalance::query()->with(['emp_id','holidaytype_id',])->select("holiday_palances.*")  ;
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'holidayPalance',
                 'data'=>'holidayPalance',
                 'title'=>trans('admin.holidayPalance'),
		    ],
				[
                 'name'=>'emp_id."emp_name"',
                 'data'=>'emp_id."emp_name"',
                 'title'=>trans('admin.emp_id'),
		    ],
				[
                 'name'=>'holidaytype_id."holidaytype"',
                 'data'=>'holidaytype_id."holidaytype"',
                 'title'=>trans('admin.holidaytype_id'),
		    ],
				[
                 'name'=>'note',
                 'data'=>'note',
