...
class holidaysDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.holidays.buttons.actions')
    ...
    {
        return holiday::query()->select("holidaies.*")  ;
	    ...
	    protected function getColumns()
	    {
            ...
            [
				...
				[
                 'name'=>'holiday_desc',
                 'data'=>'holiday_desc',
                 'title'=>trans('admin.holiday_desc'),
		    ],
				[
                 'name'=>'holidays_days',
                 'data'=>'holidays_days',
                 'title'=>trans('admin.holidays_days'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
