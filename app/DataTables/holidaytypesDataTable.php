...
class holidaytypesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.holidaytypes.buttons.actions')
    ...
    {
        return holidaytype::query()->select("holidaytypes.*")  ;
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'holidaytype',
                 'data'=>'holidaytype',
                 'title'=>trans('admin.holidaytype'),
		    ],
                [
                    'name'=>'type_days',
                    'data'=>'type_days',
                    'title'=>trans('admin.type_days'),
                ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
