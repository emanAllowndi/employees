...
class officialHolidaysDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.officialholidays.buttons.actions')
...

    {
        ...
        return officialHoliday::query()->select("official_holidaies.*")  ->where('oyear','=',$year)->get();;
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'holiday_name',
                 'data'=>'holiday_name',
                 'title'=>trans('admin.holiday_name'),
		    ],

				[
                 'name'=>'holiday_month',
                 'data'=>'holiday_month',
                 'title'=>trans('admin.holiday_month'),
            ],
            [
                'name'=>'holiday_month_end',
                'data'=>'holiday_month_end',
                'title'=>trans('admin.holiday_month_end'),
           ],
