...
class publicAdminsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.publicadmins.buttons.actions')
    ...
    {
        return publicAdmin::query()->with(['sector_id',])->select("public_admins.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'publicAdmin',
                 'data'=>'publicAdmin',
                 'title'=>trans('admin.publicAdmin'),
		    ],
				[
                 'name'=>'sector_id.sector',
                 'data'=>'sector_id.sector',
                 'title'=>trans('admin.sector_id'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
