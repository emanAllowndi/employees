...
class ratingsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.ratings.buttons.actions')
     ...
     */
	public function query($task_id)
    {
        return rating::query($task_id)->with(['task',])->select("ratings.*")->where('task_id', '=',$task_id)->get();
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'rating',
                 'data'=>'rating',
                 'title'=>trans('admin.rating'),
		    ],
				[
                 'name'=>'task_id."task_name"',
                 'data'=>'task_id."task_name"',
                 'title'=>trans('admin.task_id'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
