...
class tasksDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.tasks.buttons.actions')
     ...
     */
	public function query($emp_id)
    {
        return task::query($emp_id)->with(['emp_id',])->select("tasks.*")->where('emp_id', '=',$emp_id)  ->get();


      //  return task::query()->with('emp_id')->select("tasks.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'task_name',
                 'data'=>'task_name',
                 'title'=>trans('admin.task_name'),
		    ],
				[
                 'name'=>'task_desc',
                 'data'=>'task_desc',
                 'title'=>trans('admin.task_desc'),
		    ],
				[
                 'name'=>'days',
                 'data'=>'days',
                 'title'=>trans('admin.days'),
		    ],
				[
                 'name'=>'status',
                 'data'=>'status',
