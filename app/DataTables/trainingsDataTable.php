...
class trainingsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.trainings.buttons.actions')
    ...
    {
        return training::query()->with(['emp_id',])->select("trainings.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'tradate',
                 'data'=>'tradate',
                 'title'=>trans('admin.tradate'),
		    ],
				[
                 'name'=>'trayear',
                 'data'=>'trayear',
                 'title'=>trans('admin.trayear'),
		    ],
				[
