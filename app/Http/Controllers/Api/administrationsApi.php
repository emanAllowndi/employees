...
class administrationsApi extends Controller
{
            ...
            public function index()
            {
               ...
               "status"=>true,
               "data"=>administration::orderBy('id','desc')->paginate(15)
               ]);
            }
    ...
    public function store()
    {
        $rules = [
                         'administration'=>'',
             'publicAdmin_id'=>'required|numeric',
        ];
        ...
        $create = administration::create($data);
