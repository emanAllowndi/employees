                    ...
                    <div class="row">
                        <div class="col-md-12 holi" style="border: 1px solid #0d5d64;">
                            <div class="col-md-8 "  style="margin-top: 100px;">
                                <form action="{{ route('behaviors.storefromhome') }}" enctype="multipart/form-data" class="form-horizontal form-row-seperated" method="POST" >
                                    ...
                                    <div class="form-group">
                                        <label for="behavior" class="col-md-2 control-label">{{trans('admin.behavior')}}</label>
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label for="bedate" class="col-md-2 control-label">{{trans('admin.bedate')}}</label>
                                        <div class="col-md-10">
                                            <input type="date" id="bedate" name="bedate" value="{{date('Y-m-d')}}" min="0" max="5" class="form-control"  placeholder="{{trans('admin.bedate')}}" />
                                        </div>
                                    </div>
                                    <br>
                            ...
                            <div class="col-md-4 holileft" style="background-color: #0d5d64;">
                                <div class="row">
