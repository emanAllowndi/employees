...
{{--								<li>--}}
{{--										<a href="{{ aurl('/closedyears/'.$id.'/edit')}}"><i class="fa fa-pencil-square-o"></i> {{trans('admin.edit')}}</a>--}}
{{--								</li>--}}
{{--								<li class="divider"> </li>--}}
								<li>
										<a href="{{ aurl('/closedyears/'.$id)}}"><i class="fa fa-eye"></i> {{trans('admin.show')}}</a>
								</li>
{{--								<li>--}}
