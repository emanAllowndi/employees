								...
								<div class="row col-md-12">
                                    ...
                                    <div class="rightemp col-md-7">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12" >
                                                {!! Form::text('emp_name',old('emp_name'),['class'=>'form-control' ,'placeholder'=>trans('admin.emp_name')])  !!}
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                {!! Form::text('third_name',old('third_name'),['class'=>'form-control','placeholder'=>trans('admin.third_name')]) !!}
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                {!! Form::number('phone_num',old('phone_num'),['class'=>'form-control','placeholder'=>trans('admin.phone_num')]) !!}
                                            </div>
                                        </div>
                                        <br>
                                    ...
                                    <div class="leftemp col-md-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                {!! Form::select('job_id',App\Model\job::pluck("job_name","id"),old('job_id'),['class'=>'form-control','placeholder'=>trans('admin.job_id')]) !!}
                                            </div>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                {!! Form::select('department_id',App\Model\department::pluck("department_name","id"),old('department_id'),['class'=>'form-control','placeholder'=>trans('admin.department_id')]) !!}
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                {!! Form::select('user_id',App\Model\user::pluck("first_name","id"),old('user_id'),['class'=>'form-control','placeholder'=>trans('admin.user_id')]) !!}
                                            </div>
                                        ...
                                        <div class="tab-content" style="padding:10px;">
                                            <div id="cv" class="tab-pane active">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        {!! Form::file('cv',old('cv'),['class'=>'form-control','placeholder'=>trans('admin.cv')]) !!}
                                                    </div>
                                                </div>
                                                <br>
                                            </div>
                                            ...
                                            <div id="private" class="tab-pane">
                                                ...
                                                <div class="rightemp col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::text('emergency_person',old('emergency_person'),['class'=>'form-control','placeholder'=>trans('admin.emergency_person')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('emergency_number',old('emergency_number'),['class'=>'form-control','placeholder'=>trans('admin.emergency_number')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        {!! Form::label('social',trans('admin.social'),['class'=>'col-md-3 control-label']) !!}
                                                        <div class="col-md-9">
                                                            {{ Form::select('social', array('أعزب' => 'أعزب ', 'متزوج' => 'متزوج', 'مطلق' => 'مطلق', 'ارمل' => 'ارمل'),old('social'), array('class'=>'form-control','placeholder'=>trans('admin.social') )) }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {{ Form::select('qulification', array('دكتوراة' => 'دكتوراة ', 'ماجيستير' => 'ماجيستير', 'بكالوريوس' => 'بكالوريوس', 'ثانوية' => 'ثانوية', 'لا يوجد مؤهل' => 'لا يوجد مؤهل'),old('qulification'), array('class'=>'form-control','placeholder'=>trans('admin.qulification') )) }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::text('major',old('major'),['class'=>'form-control','placeholder'=>trans('admin.major')]) !!}
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="leftemp col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('snn',old('snn'),['class'=>'form-control','placeholder'=>trans('admin.snn')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('passport',old('passport'),['class'=>'form-control','placeholder'=>trans('admin.passport')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {{ Form::select('gender', array('انثى' => 'انثى ', 'ذكر' => 'ذكر'),old('gender'), array('class'=>'form-control','placeholder'=>trans('admin.gender') )) }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::date('bitrthdate',old('bitrthdate'),['class'=>'form-control','placeholder'=>trans('admin.bitrthdate')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::text('bitrthplace',old('bitrthplace'),['class'=>'form-control','placeholder'=>trans('admin.bitrthplace')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <hr/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('sons',old('sons'),['class'=>'form-control','placeholder'=>trans('admin.sons')]) !!}
                                            ...
                                            <div id="administration" class="tab-pane">
                                                ...
                                                <div class="rightemp col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('salary',0,['class'=>'form-control','placeholder'=>trans('admin.salary')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <hr/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {{ Form::select('status', array('متعاقد' => 'متعاقد ', 'اساسي' => 'اساسي', 'منتدب' => 'منتدب', 'شيء آخر' => 'شيء آخر'),old('status'), array('class'=>'form-control','placeholder'=>trans('admin.status') )) }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::date('start_date',old('start_date'),['class'=>'form-control','placeholder'=>trans('admin.start_date')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('employment_number',old('employment_number'),['class'=>'form-control','placeholder'=>trans('admin.employment_number')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('fingerprint',old('fingerprint'),['class'=>'form-control','placeholder'=>trans('admin.fingerprint')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('account_num',old('account_num'),['class'=>'form-control','placeholder'=>trans('admin.account_num')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::file('contract',old('contract'),['class'=>'form-control','placeholder'=>trans('admin.contract')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                ...
                                                <div class="leftemp col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('motivation',0,['class'=>'form-control','placeholder'=>trans('admin.motivation')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('work_nature',0,['class'=>'form-control','placeholder'=>trans('admin.work_nature')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::text('level',old('level'),['class'=>'form-control','placeholder'=>trans('admin.level')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('transportation',0,['class'=>'form-control','placeholder'=>trans('admin.transportation')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {{ Form::select('activity', array('فعال' => 'فعال ', 'غير فعال' => 'غير فعال'),old('activity'), array('class'=>'form-control','placeholder'=>trans('admin.activity') )) }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::number('degree',old('degree'),['min'=>0 ,'max'=>20 ,'class'=>'form-control','placeholder'=>trans('admin.degree')]) !!}
                                                        </div>
                                                    </div>
                                                    <br>
