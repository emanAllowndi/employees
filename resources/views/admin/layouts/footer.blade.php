                ...
                <li> Enable Notifications
                    ...
                    <li> Allow Tracking
                        ...
                        <div class="page-footer">
                            <div class="page-footer-inner"> 2020 &copy; Ministry Of Transportation
                                <a target="_blank" href="http://emanLowndi.com">Developed by EmanLowndi</a> &nbsp;
                                |&nbsp;
                            </div>
...
@yield('footer')
    ...
    <script src="{{url('design/admin_panel')}}/assets/global/plugins/custom.js" type="text/javascript"></script>
                        ...
                        <script src="{{url('design/admin_panel')}}/assets/layouts/layout4/scripts/particles.js"></script>
    ...
    $("#example1").DataTable();
      ...
      $('.select2bs4').select2({
          theme: 'bootstrap4'
                        ...
                        particlesJS.load('particles-js', "{{url('design/admin_panel')}}/assets/layouts/layout4/css/particles.json", function() {
