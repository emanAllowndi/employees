              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('officialholidays/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.officialholidays')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$officialholidays->id}} ؟
...
<b>{{trans('admin.id')}} :</b> {{$officialholidays->id}}
</div>
<div class="clearfix"></div>
<hr />

<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.holiday_name')}} :</b>
 {!! $officialholidays->holiday_name !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.official_holidays_days')}} :</b>
 {!! $officialholidays->official_holidays_days !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.holiday_month')}} :</b>
 {!! $officialholidays->holiday_month !!}
</div>
