        ...
        <div class="col-md-12">
            <div class="widget-extra body-req portlet light bordered" >
                ...
                <div class="portlet-body form" >
                    <div class="row">
                        <div class="col-md-12 holi" style="border: 1px solid #b75991;">
                            <div class="col-md-8 "  style="margin-top: 100px;">
                                <form action="{{ route('pers.storefromhome') }}" enctype="multipart/form-data" class="form-horizontal form-row-seperated" method="POST" >
                                    ...
                                    <div class="form-group">
                                        <label for="per_cause" class="col-md-2 control-label">{{trans('admin.per_cause')}}</label>
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label for="from" class="col-md-2 control-label">{{trans('admin.from')}}</label>
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label for="to" class="col-md-2 control-label">{{trans('admin.to')}}</label>
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label for="pdate" class="col-md-2 control-label">{{trans('admin.pdate')}}</label>
                                        <div class="col-md-10">
                            ...
                            <div class="col-md-4 holileft" style="background-color: #b75991;">
                                <div class="row">
