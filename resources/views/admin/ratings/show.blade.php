              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('ratings/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.ratings')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$ratings->id}} ؟
...
<b>{{trans('admin.admin_id')}} :</b>
 {{ App\Admin::find($ratings->admin_id)->name }}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.task_id')}} :</b>
 {!! $ratings->task_id !!}
</div>
