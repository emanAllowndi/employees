                    ...
                    <div class="row">
                        <div class="col-md-12 holi" style="border: 1px solid #0d5d64;">
                            <div class="col-md-8 "  style="margin-top: 100px;">
                                <form action="{{ route('tasks.storefromhome') }}" enctype="multipart/form-data" class="form-horizontal form-row-seperated" method="POST" >
                                    ...
                                    <div class="form-group">
                                        {!! Form::label('task_name',trans('admin.task_name'),['class'=>'col-md-2 control-label']) !!}
                                        <div class="col-md-10">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        {!! Form::label('task_desc',trans('admin.task_desc'),['class'=>'col-md-2 control-label']) !!}
                                        <div class="col-md-10">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        {!! Form::label('days',trans('admin.days'),['class'=>'col-md-2 control-label']) !!}
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        {!! Form::label('type',trans('admin.type'),['class'=>'col-md-2 control-label']) !!}
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        {!! Form::label('status',trans('admin.status'),['class'=>'col-md-2 control-label']) !!}
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        {!! Form::label('tdate',trans('admin.tdate'),['class'=>'col-md-2 control-label']) !!}
                                        <div class="col-md-10">
