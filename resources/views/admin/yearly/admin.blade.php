...
@section('content')
    ...
    use App\Model\behavior;use App\Model\emp;use App\Model\training;
    ...
    <div class="row">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption">
                        ...
                        @if(Request::isMethod('get'))
                            ...
                            <span class="caption-subject bold uppercase font-dark">تقرير اداء ادارة   </span>

                        @endif
                        @if(Request::isMethod('post'))

                            <?php
                            session()->put('admin', $_POST['admin']);
                            session()->put('from_date', $_POST['from_date']);
                            session()->put('to_date', $_POST['to_date']);

                            $emp= emp::with('department','administration','publicAdmin','user','job','sector')->where('deleted_at','=',null)->where('administration_id','=',$_POST['admin'])->first();
                            $admin=\App\Model\administration::with('publicAdmin','emps')->where('deleted_at','=',null)->where('id','=',$_POST['admin'])->first();
                            ?>
                            @if(empty($_POST['from_date']) && isset($_POST['admin']))
                                <span class="caption-subject bold uppercase font-dark">تقرير اداء ادارة {!! $admin->administration !!} </span>




                            @endif
                            @if(isset($_POST['from_date']) && ($_POST['from_date'] !='') && isset($_POST['admin']))

                                    <span class="caption-subject bold uppercase font-dark">تقرير اداء ادارة {!! $admin->administration !!}
                            ...
                            <div class="row col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <h5>القطاع :
                                        ...
                                        {!! $admin->publicAdmin->sector->sector !!}
                                    </h5>
                                </div>
                    ...
                    <table  class="table table-bordered table-striped">
                        ...
                        @foreach($allemps as $allemp)
                            ...
                            @if(empty($_POST['from_date']))
                                ...
                                <?php
                                $attendances=  \App\Model\attendance::with('emp')->where('deleted_at','=',null)->where('emp_id','=',$allemp->id)->where('ayear','=',$year)->get();
        ...
        <div class="col-lg-3 col-md-4">
            <div class="filter-report clearfix">
                ...
                <form method="post" action="{{route('reports.admin')}}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" id="report-type" class="custom-select-black" onchange="location = this.value;">
                            ...
                            <option value="{{route('reports.admin')}}" selected="">
                                تقرير اداء  ادارة
                            </option>
                    ...
                    <div class="form-group">
                        ...
                        $admins=DB::table('administrations')->where('deleted_at','=',null)->get();
                        ?>

                        <select class="form-control select2bs4" name="admin" >
                            @foreach($admins as $admin)
                                <option value="{!! $admin->id !!}" name="admin" >
